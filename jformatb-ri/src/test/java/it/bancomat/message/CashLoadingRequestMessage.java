...
@Format(pattern = "${requestType:3}${workstationId:4}${transactionNumber:5}${dateTime:10}0${anomalyCode:2:00}${transmissionFlag:1:0}${cassettes:7:0000000}[3]${type:1}${cassettes[0].currency:3:000}${cassettes[1].currency:3:000}${cassettes[2].currency:3:000}")
@FormatTypeValue("A04")
